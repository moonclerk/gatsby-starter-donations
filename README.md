![Header](https://res.cloudinary.com/moonclerk/image/upload/v1589921007/donation_header_nidlhe.jpg)

# gatsby-starter-donations

A Gatsby starter to help get up and running accepting donations using Gatsby + MoonClerk. Easily create lightning fast static landing pages with MoonClerk forms.
...
1.  **Create a Gatsby site.**
    ...
    gatsby new gatsby-starter-donations https://github.com/moonclerk/gatsby-starter-donations
    ```
...
4. Open _`/src/components/atoms/donationForm.js`_
...
8. Run **`gatsby build && gatsby serve`**

## 🚀 Deploy

[![Deploy](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/moonclerk/gatsby-starter-donations)
